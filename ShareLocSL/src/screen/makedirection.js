...
export default class MakeDirectionScreen extends BaseScreen {
    ...
    directionDragEnd(direction, newCoordinate){
        ...
        var previous = this.getPreviousDirection(direction.index);
        ...
        var nexts = this.getNextDirection(direction.index);
        if(nexts.length > 0){
            var next = nexts[0];
